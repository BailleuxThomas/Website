...
<div class="row">
                <div class="col l6 s12">
                    <h4 class="white-text">Bailleuxthomas.com</h4>
                    <p>
                    « Un bug n’est jamais qu’une erreur. Il représente quelque chose de plus grand. Une erreur de pensée. Ça fait de vous qui vous êtes. – Elliot Alderson »
                    </p>
                    <div id="using">
                        <h5>Règles d'utilisation</h5>
                        <p>En utilisant le "chat", vous acceptez d'être supprimé et/ou banni si vous envoyez n'importe quoi!</p>
                    </div>
                </div>
